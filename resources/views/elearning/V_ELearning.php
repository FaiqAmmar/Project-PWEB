...
<div class="relative w-full flex flex-col px-16 py-8">
  ...
  <div class="flex flex-row py-6 items-center gap-4">
    ...
    <?php endif; ?>
    <form class="flex flex-row items-center gap-10">   
      <div class="relative">
        ...
        border border-[#1F1D59] rounded-lg focus:border-[#171473] focus:ring-2 focus:outline-none focus:ring-[#171473]" placeholder="Cari elearning..." required />
      </div>
    </form>
  </div>
  <table>
    ...
    <tbody>
      <tr>
        <td class="border border-[#DDDDDD] px-3 py-2">E-Learning 1</td>
        <?php if ($userRoleData['role'] === 'Admin') : ?>
        <td class="border border-[#DDDDDD] px-3 py-2 flex flex-row gap-4 justify-center">
          <a href="<?= urlpath('edit-elearning') ?>" class="flex w-auto text-white py-2 px-4 rounded-lg bg-[#171473]
          hover:bg-[#0f0f5a] hover:scale-105 transition-all duration-200">
            Edit
          </a>
          <a href="" class="flex w-auto text-[#101828] py-2 px-4 rounded-lg bg-[#F9FAFB] border border-[#171473]
        ...
        <?php elseif ($userRoleData['role'] === 'Seeker') : ?>
        <td class="border border-[#DDDDDD] px-3 py-2 flex flex-row gap-4 justify-center">
          <a href="<?= urlpath('detail-elearning') ?>" class="flex w-auto text-white py-2 px-4 rounded-lg bg-[#171473]
          hover:bg-[#0f0f5a] hover:scale-105 transition-all duration-200">
            Lihat E-Learning
          </a>
        </td>
